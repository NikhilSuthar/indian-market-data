    ...
    "capital_market": {
        ...
        "equities_sme": {
            ...
            "bhavcopy_pr": DatasetConfig(
                ...
                file_format="zip_csv",
                zip_extract=r"^pr\d{6,8}\.csv$",  # extract pr file by default
                frequency="Daily",
            ...
            "corpbond": DatasetConfig(
                ...
                file_format="zip_csv",
                zip_extract=r"^corpbond\d{6,8}\.csv$",
                frequency="Daily",
