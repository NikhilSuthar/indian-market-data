    ...
    "capital_market": {
        ...
        "equities_sme": {
            ...
            "auction_buy": DatasetConfig(
                ...
                description="Auction-buy session results. Skip first row (header line with date info). NSE portal session required — not available via direct archive URL",
                url_pattern="",
                base_url="",
            ...
            "cm_latency": DatasetConfig(
                ...
                description="Order/trade latency statistics for cash market. NSE portal session required — not available via direct archive URL",
                url_pattern="",
                base_url="",
            ...
            "mf_var": DatasetConfig(
                ...
                description="Daily VaR applicable to MF units pledged as collateral. NSE portal session required — not available via direct archive URL",
                url_pattern="",
                base_url="",
            ...
            "appsec_collval": DatasetConfig(
                ...
                description="Daily haircut-applied valuation of securities accepted as collateral. NSE portal session required — not available via direct archive URL",
                url_pattern="",
                base_url="",
            ...
            "csqr": DatasetConfig(
                ...
                description="Client-level collateral segregation summary. No header row. NSE portal session required — not available via direct archive URL",
                url_pattern="",
                base_url="",
            ...
            "c_stt": DatasetConfig(
                ...
                description="Daily STT collection per security. NSE portal session required — not available via direct archive URL",
                url_pattern="",
                base_url="",
            ...
            "c_stt_ind": DatasetConfig(
                ...
                description="STT indicator flags per security/series. NSE portal session required — not available via direct archive URL",
                url_pattern="",
                base_url="",
            ...
            "fcm_bc": DatasetConfig(
                ...
                description="Interim bhavcopy for clearing/margining before EOD files. Fixed-width DAT. NSE portal session required — not available via direct archive URL",
                url_pattern="",
                base_url="",
            ...
            "mrg_trading": DatasetConfig(
                ...
                description="Margin trading facility activity. Delivered as ZIP. NSE portal session required — not available via direct archive URL",
                url_pattern="",
                base_url="",
            ...
            "daily_settlement_doc": DatasetConfig(
                ...
                description="Word document with daily settlement statistics. NSE portal session required — not available via direct archive URL",
                url_pattern="",
                base_url="",
        ...
        "mutual_fund": {
            ...
            "nsccl_cm_ann_mf": DatasetConfig(
                ...
                description="NSCCL CM Annexure for mutual funds — ZIP containing XLSX workbook. "
                            "Use sheet_name param or sheet index to access specific sheet. NSE portal session required — not available via direct archive URL",
                url_pattern="",
                base_url="",
        ...
        "slb": {
            ...
            "slb_bc": DatasetConfig(
                ...
                description="Daily SLB segment trade summary. Fixed-width DAT format. NSE portal session required — not available via direct archive URL",
                url_pattern="",
                base_url="",
            ...
            "slb_var": DatasetConfig(
                ...
                description="VaR margin parameter file for SLB segment. NSE portal session required — not available via direct archive URL",
                url_pattern="",
                base_url="",
            ...
            "slb_transaction_data": DatasetConfig(
                ...
                description="Monthly SLB transaction dump with yields and turnover. NSE portal session required — not available via direct archive URL",
                url_pattern="",
                base_url="",
    ...
    "derivatives": {
        ...
        "interest_rate": {
            ...
            "i_volt": DatasetConfig(
                ...
                description="Interest Rate Derivative volatility file. NSE portal session required — not available via direct archive URL",
                url_pattern="",
                base_url="",
            ...
            "cd_sett_irf": DatasetConfig(
                ...
                description="Settlement prices for Interest Rate Futures contracts. NSE portal session required — not available via direct archive URL",
                url_pattern="",
                base_url="",
            ...
            "ewpl": DatasetConfig(
                ...
                description="EWPL for interest rate derivatives. NSE portal session required — not available via direct archive URL",
                url_pattern="",
                base_url="",
            ...
            "tenure_symbol_map": DatasetConfig(
                ...
                description="Maps IRD tenures to symbols. LST fixed-width format. NSE portal session required — not available via direct archive URL",
                url_pattern="",
                base_url="",
            ...
            "irf_cli_oi": DatasetConfig(
                ...
                description="IRF client-level open interest limits. NSE portal session required — not available via direct archive URL",
                url_pattern="",
                base_url="",
            ...
            "irf_tm_oi": DatasetConfig(
                ...
                description="IRF trading member open interest limits. NSE portal session required — not available via direct archive URL",
                url_pattern="",
                base_url="",
    ...
    "debt": {
        ...
        "debt_segment": {
            ...
            "dly_bundle": DatasetConfig(
                ...
                description="WDM daily files bundle. ZIP containing daily debt market files. NSE portal session required — not available via direct archive URL",
                url_pattern="",
                base_url="",
