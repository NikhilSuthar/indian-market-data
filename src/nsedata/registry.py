    ...
    "capital_market": {
        ...
        "equities_sme": {
            ...
            "52wk_high_low": DatasetConfig(
                ...
                description="Securities hitting new 52-week high or low. Adjusted for corporate actions.",
                url_pattern="/content/equities/CM_52_wk_High_low_{ddmmyyyy}.csv",
            ...
            "pe": DatasetConfig(
                ...
                url_pattern="/archives/equities/mkt/PE_{ddmmyy}.csv",
            ...
            "reg_ind": DatasetConfig(
                ...
                url_pattern="/archives/equities/mkt/REG_IND{ddmmyy}.csv",
            ...
            "reg1_ind": DatasetConfig(
                ...
                url_pattern="/archives/equities/mkt/REG1_IND{ddmmyy}.csv",
            ...
            "sme": DatasetConfig(
                ...
                url_pattern="/archives/sme/sme{ddmmyyyy}.csv",
            ...
            "sme_bands": DatasetConfig(
                ...
                url_pattern="/archives/sme/sme_bands_complete_{ddmmyyyy}.csv",
            ...
            "eq_band_changes": DatasetConfig(
                ...
                url_pattern="/archives/equities/eq_band_changes_{ddmmyyyy}.csv",
            ...
            "sec_list": DatasetConfig(
                ...
                url_pattern="/archives/equities/sec_list_{ddmmyyyy}.csv",
            ...
            "auction_buy": DatasetConfig(
                ...
                description="Auction-buy session results. Skip first row (header line with date info).",
                url_pattern="/archives/equities/aub/AUB_{settno}_{ddmmyyyy}.csv",
            ...
            "cm_latency": DatasetConfig(
                ...
                url_pattern="/archives/equities/latency/CM_Latency_stats{ddmmyyyy}.csv",
            ...
            "mf_var": DatasetConfig(
                ...
                url_pattern="/archives/nsccl/mf_var/MF_VAR_{ddmmyyyy}.csv",
            ...
            "appsec_collval": DatasetConfig(
                ...
                url_pattern="/archives/nsccl/collval/APPSEC_COLLVAL_{ddmmyyyy}.csv",
            ...
            "csqr": DatasetConfig(
                ...
                description="Client-level collateral segregation summary. No header row.",
                url_pattern="/archives/nsccl/csqr/CSQR_M_{ddmmyyyy}.csv",
                file_pattern="CSQR_M_{ddmmyyyy}.csv",
                file_format="csv",
                frequency="Daily",
            ...
            "c_stt": DatasetConfig(
                ...
                url_pattern="/archives/nsccl/stt/C_STT_{ddmmyyyy}.csv",
            ...
            "c_stt_ind": DatasetConfig(
                ...
                url_pattern="/archives/nsccl/stt/C_STT_IND_{ddmmyyyy}.csv",
            ...
            "fcm_bc": DatasetConfig(
                ...
                description="Interim bhavcopy for clearing/margining before EOD files. Fixed-width DAT.",
                url_pattern="/archives/nsccl/fcm/FCM_INTRM_BC{ddmmyyyy}.DAT",
            ...
            "mrg_trading": DatasetConfig(
                ...
                description="Margin trading facility activity. Delivered as ZIP.",
                url_pattern="/archives/equities/mgt/mrg_trading_{ddmmyy}.zip",
            ...
            "c_catg": DatasetConfig(
                ...
                url_pattern="/archives/nsccl/cs/C_CATG_{MON}{YYYY}.T01",
            ...
            "daily_settlement_doc": DatasetConfig(
                ...
                description="Word document with daily settlement statistics.",
                url_pattern="/archives/equities/daily_settlement/Daily_Settlement_Statistics_{ddmmyyyy}.doc",
        ...
        "indices": {
            ...
            "top_movers": DatasetConfig(
                ...
                url_pattern="/archives/equities/mkt/top10nifty50_{ddmmyy}.csv",
        ...
        "mutual_fund": {
            ...
            "nsccl_cm_ann_mf": DatasetConfig(
                ...
                url_pattern="/archives/nsccl/mf/nsccl_cm_ann_mf.zip",
        ...
        "slb": {
            ...
            "slb_elg_sec": DatasetConfig(
                ...
                description="List of securities eligible for lending/borrowing with eligibility types.",
                url_pattern="/archives/nsccl/slb/SLB_ELG_SEC_{ddmmyyyy}.csv",
            ...
            "slb_openpos": DatasetConfig(
                ...
                description="Open positions at SLB member/client level.",
                url_pattern="/archives/nsccl/slb/slb_openpos_{ddmmyyyy}.csv",
            ...
            "slb_foreclosure": DatasetConfig(
                ...
                description="SLB foreclosure events with corporate action details.",
                url_pattern="/archives/nsccl/slb/Forclosure_SLB_{yyyymmdd}.CSV",
            ...
            "slb_bc": DatasetConfig(
                ...
                url_pattern="/archives/nsccl/slb/SLBM_BC_{ddmmyyyy}.DAT",
            ...
            "slb_var": DatasetConfig(
                ...
                url_pattern="/archives/nsccl/slb/C_VAR1_SLB_{ddmmyyyy}_1.DAT",
            ...
            "slb_positions": DatasetConfig(
                name="SLB Positions",
                description="SLB positions weekly/monthly. Excel format (XLS).",
                url_pattern="/archives/nsccl/slb/slbs_positions_{ddmmyyyy}.xls",
            ...
            "slb_transactions": DatasetConfig(
                ...
                description="SLB transaction data weekly/monthly. Excel format (XLS).",
                url_pattern="/archives/nsccl/slb/slbs_transactions_{ddmmyyyy}.xls",
            ...
            "slb_cli": DatasetConfig(
                ...
                description="Monthly client-level SLB position limits.",
                url_pattern="/archives/nsccl/slb/slbs_cli_{mon}{yyyy}.csv",
            ...
            "slb_fopl": DatasetConfig(
                ...
                description="Monthly SLB fund-of-pool limit statistics.",
                url_pattern="/archives/nsccl/slb/slbs_fopl_{mon}{yyyy}.csv",
            ...
            "slb_mpl": DatasetConfig(
                ...
                description="Monthly member-level position-limit utilization.",
                url_pattern="/archives/nsccl/slb/slbs_mpl_{mon}{yyyy}.csv",
            ...
            "slb_ppl": DatasetConfig(
                ...
                description="Monthly pool-level position-limit utilization.",
                url_pattern="/archives/nsccl/slb/slbs_ppl_{mon}{yyyy}.csv",
            ...
            "slb_transaction_data": DatasetConfig(
                ...
                url_pattern="/archives/nsccl/slb/SLB_Transaction_Data_{Mon}{YYYY}.csv",
    ...
    "derivatives": {
        ...
        "equity": {
            ...
            "fopl": DatasetConfig(
                ...
                url_pattern="/archives/fo/fopl_{mon}{yyyy}.csv",
            ...
            "mpl": DatasetConfig(
                ...
                url_pattern="/archives/fo/mpl_{mon}{yyyy}.csv",
            ...
            "tmopl": DatasetConfig(
                ...
                url_pattern="/archives/fo/tmopl_{mon}{yyyy}.csv",
            ...
            "fo_impact_cost": DatasetConfig(
                ...
                url_pattern="/archives/fo/ic_{mon}{yyyy}.csv",
        ...
        "commodity": {
            ...
            "payinpayout": DatasetConfig(
                ...
                description="Monthly commodity derivatives pay-in / pay-out report. ZIP of files.",
                url_pattern="/archives/nsccl/com/Payinpayout_{MON}{YYYY}.zip",
        ...
        "currency": {
            ...
            "cd_bhav_udiff": DatasetConfig(
                ...
                description="Currency derivatives bhavcopy in UDiFF format.",
                url_pattern="/content/cd/BhavCopy_NSE_CD_0_0_0_{yyyymmdd}_F_0000.csv.zip",
            ...
            "cd_pos_clients": DatasetConfig(
                ...
                description="Currency derivatives position of clients. Excel XLS format. "
                            "Skip first row to get tabular data.",
                url_pattern="/archives/nsccl/cd/cd_pos_of_clients.xls",
        ...
        "interest_rate": {
            ...
            "irf_bhavcopy": DatasetConfig(
                ...
                description="Interest Rate Futures bhavcopy. ZIP containing CSV files.",
                url_pattern="/archives/fo/IRF_Bhavcopy{ddmmyy}.zip",
            ...
            "i_volt": DatasetConfig(
                ...
                url_pattern="/archives/nsccl/volt/I_VOLT_{ddmmyyyy}.csv",
            ...
            "cd_sett_irf": DatasetConfig(
                ...
                url_pattern="/archives/nsccl/cd/CDSett_prce_IRF_{ddmmyyyy}.csv",
            ...
            "ewpl": DatasetConfig(
                ...
                url_pattern="/archives/fo/EWPL_{ddmmyyyy}.CSV",
            ...
            "fpi_long": DatasetConfig(
                ...
                description="Combined FPI long positions across derivatives. Encoding: latin-1.",
                url_pattern="/archives/fo/Combined_FPI_long_psn_{ddmmyyyy}.csv",
            ...
            "fii_long": DatasetConfig(
                ...
                description="FII long positions in derivatives. Encoding: latin-1.",
                url_pattern="/archives/fo/fii_longpos_{ddmmyyyy}.csv",
            ...
            "tenure_symbol_map": DatasetConfig(
                ...
                description="Maps IRD tenures to symbols. LST fixed-width format.",
                url_pattern="/archives/fo/TENURE_SYMBOL_MAP_{ddMon-YYYY}.lst",
            ...
            "irf_cli_oi": DatasetConfig(
                ...
                description="IRF client-level open interest limits.",
                url_pattern="/archives/fo/i_oi_cli_limit_{ddMon-YYYY}.lst",
            ...
            "irf_tm_oi": DatasetConfig(
                ...
                description="IRF trading member open interest limits.",
                url_pattern="/archives/fo/i_oi_tm_limit_{ddMon-YYYY}.lst",
    ...
    "debt": {
        ...
        "corporate": {
            ...
            "cbm_trd": DatasetConfig(
                ...
                description="Daily trades in corporate bonds: price, yield, value.",
                url_pattern="/archives/debt/cbm_trd{yyyymmdd}.csv",
            ...
            "cbm_list_man": DatasetConfig(
                ...
                description="Mandatory-settlement corporate bond list.",
                url_pattern="/archives/debt/cbm_list_man_{ddmmyyyy}.csv",
            ...
            "cbm_list_non_man": DatasetConfig(
                ...
                description="Non-mandatory corporate bond settlement list.",
                url_pattern="/archives/debt/cbm_list_non_man_{ddmmyyyy}.csv",
            ...
            "cbm_fail": DatasetConfig(
                ...
                description="Corporate bond trades that failed settlement.",
                url_pattern="/archives/debt/cbm_fail_{ddmmyyyy}.csv",
            ...
            "cbm_unlist_man": DatasetConfig(
                ...
                description="Unlisted CB mandatory settlement list.",
                url_pattern="/archives/debt/cbm_unlist_man_{ddmmyyyy}.csv",
            ...
            "cbm_unlist_non_man": DatasetConfig(
                ...
                description="Unlisted CB non-mandatory settlement list.",
                url_pattern="/archives/debt/cbm_unlist_non_man_{ddmmyyyy}.csv",
            ...
            "sdt_fail": DatasetConfig(
                ...
                description="Failed settlement direct trades.",
                url_pattern="/archives/debt/sdt_fail_{ddmmyyyy}.csv",
            ...
            "sdt_list_man": DatasetConfig(
                ...
                description="Mandatory SDT settlement list.",
                url_pattern="/archives/debt/sdt_list_man_{ddmmyyyy}.csv",
            ...
            "sdt_list_non_man": DatasetConfig(
                ...
                description="Non-mandatory SDT settlement list.",
                url_pattern="/archives/debt/sdt_list_non_man_{ddmmyyyy}.csv",
            ...
            "sdt_unlist_man": DatasetConfig(
                ...
                description="Unlisted mandatory SDT settlement.",
                url_pattern="/archives/debt/sdt_unlist_man_{ddmmyyyy}.csv",
            ...
            "sdt_unlist_non_man": DatasetConfig(
                ...
                description="Unlisted non-mandatory SDT settlement.",
                url_pattern="/archives/debt/sdt_unlist_non_man_{ddmmyyyy}.csv",
            ...
            "cp_settlement": DatasetConfig(
                ...
                description="Settlement orders for commercial paper segment.",
                url_pattern="/archives/debt/CP_SettlementOrderReport_{ddmmyyyy}.csv",
            ...
            "cd_settlement": DatasetConfig(
                ...
                description="Settlement orders for convertible debenture segment.",
                url_pattern="/archives/debt/CD_SettlementOrderReport_{ddmmyyyy}.csv",
            ...
            "gsec_settlement": DatasetConfig(
                ...
                description="G-Sec settlement order report.",
                url_pattern="/archives/debt/GSEC_SettlementOrderReport_{ddmmyyyy}.csv",
            ...
            "corporate_bond_report": DatasetConfig(
                ...
                description="Monthly CB market statistics. Large CSV with multiple sections.",
                url_pattern="/archives/debt/Corporate_bond_report_{dd-Mon-YYYY}.csv",
        ...
        "debt_segment": {
            ...
            "wdmlist": DatasetConfig(
                ...
                description="Current WDM security list with ISIN, description, face value.",
                url_pattern="/archives/debt/wdmlist_{ddmmyyyy}.csv",
            ...
            "dly_bundle": DatasetConfig(
                ...
                url_pattern="/archives/debt/dly{ddmmyyyy}.zip",
            ...
            "wkly_bundle": DatasetConfig(
                ...
                description="WDM weekly files bundle. ZIP containing weekly debt market files.",
                url_pattern="/archives/debt/wkly{ddmmyyyy}.zip",
            ...
            "accrued_interest": DatasetConfig(
                ...
                description="Monthly accrued interest file for WDM securities.",
                url_pattern="/archives/debt/ACCTINT_{MON}{YYYY}.csv",
        ...
        "tri_party_repo": {
            ...
            "trm_bc": DatasetConfig(
                ...
                url_pattern="/archives/trep/TRM_BC{ddmmyyyy}.csv",
